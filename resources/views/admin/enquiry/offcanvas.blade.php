<div class="offcanvas offcanvas-end offcanvas-size-50" tabindex="-1" id="offcanvasCreate"
    ...
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasCreate">{{ isset($enquiry) ? 'Edit' : 'Create new' }} enquiry</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">

        @if (isset($enquiry))
            {{ html()->form('PATCH', route('blogs.update', $enquiry->id))->id('blog-form')->open() }}
        @else
            ...
            <div class="col-12">
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->input('text', 'title', isset($enquiry) ? $enquiry->title : old('title'))->placeholder('Enter title')->class('form-control ' . ($errors->has('title') ? 'is-invalid' : '')) }}
                        @error('title')
