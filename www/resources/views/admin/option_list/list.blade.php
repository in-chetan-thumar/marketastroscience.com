                ...
                <div class="card-body">
                    <div class="float-end ">
                        <div class="row row-cols-lg-auto g-3 align-items-center">
                            ...
                            <a href="{{ route('option-list.create') }}" onclick="showSaveModel(event)"
                                class="btn btn-dark right-button ms-3"><i class="mdi mdi-plus"></i>&nbsp;Add new option</a>
                            {{-- @endcan --}}
                        </div>
                    ...
                    <div class="float-start">
                        ...
                        <div class="form-group ">
                            {{ html()->select('list_type', config('constants.OPTION_LIST_TYPE'), request()->query('list_type'))->placeholder('Select list type')->id('option-type-dropdown')->class('form-control form-select') }}
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group">
                            <a href="{{ route('option-list.index') }}"
                    ...
                    <div class="divtable">
                        @include('admin.option_list.table')
                    </div>
                </div>
            </div>
        </div>
...
@section('script-bottom')
    ...
    <script type="text/javascript" src="{{ asset('assets/js/option_list.js') }}"></script>
    <script>
        $(document).ready(function() {
            initializeDataTable({
                moduleNmae: 'option',
                tableSelector: '#option-table-data', // Table id
                ajaxUrl: "/get-option", // AJAX endpoint
