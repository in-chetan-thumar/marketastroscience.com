                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="p-2 mt-4">
                                    <div class="text-muted text-center mb-4 mx-lg-3">
                                        ...
                                        <p>Please enter the 6 digit code sent to <span class="fw-semibold">
                                                @if (config('constants.EMAIL_OTP_LOGIN'))
                                                    {{ app('common-helper')->maskEmailAddress($user->email) }}
                                                @elseif(config('constants.MOBILE_OTP_LOGIN'))
                                                    {{ app('common-helper')->maskPhoneNumber($user->mobile) }}
                                                @endif
                                            </span></p>
                                    </div>
                        ...
                        <div class="mt-4 text-center">
                            @if ($user->is_account_locked == 'N')
                                <p class="mb-0">Didn't receive a code ? <a href="{{ route('admin.verify.resend') }}"
