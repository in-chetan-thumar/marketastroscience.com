                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="email_template_content" id="email_template_content" name="email_template_content"
                                            aria-describedby="example-hint">{{ $emailtemplate->html_template }}</textarea>
