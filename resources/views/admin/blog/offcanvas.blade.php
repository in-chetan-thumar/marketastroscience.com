              ...
              <div class="col-12">
                  <div class="mb-3">
                      <div class="form-group">
                          ...
                          {{-- <textarea class="description" id="description" name="description" aria-describedby="example-hint">{{ isset($blog) ? $blog->description : old('description') }}</textarea> --}}
                          <textarea class="description" id="description" name="description" aria-describedby="example-hint">{{ isset($blog) ? $blog->description : old('description') }}</textarea>
                          @error('description')
  ...
  <script type="module">
      ...
      function initializeEditor() {
          ClassicEditor
              .create(document.querySelector('#description'), {
                  plugins: [
                      Essentials, Paragraph, Bold, Italic, Font, Alignment, List, Link,
                  ...
                  toolbar: [
                      ...
                      'bulletedList', 'numberedList', '|', 'link', 'insertImage', 'insertTable', 'mediaEmbed'
                  ],
                  image: {
                      toolbar: [
      ...
      // );
      // bsOffcanvas.show();
      // $('#modal-send-file').on('shown.bs.modal', function() {
      //     if (!editorInstance) {
