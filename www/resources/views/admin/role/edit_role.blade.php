        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {{ html()->form('PATCH', route('roles.update', $role->id))->id('role-form')->open() }}
                    <div class="row">
                        <div class="col-xs-6 col-sm-12 col-md-6">
                            <div class="mb-3">
                                <div class="form-group">
                                    {{ html()->label('Role') }}<span class="required">*</span>
                                    {{ html()->input('text', 'name', isset($role) ? $role->name : old('name'))->placeholder('Enter name')->class('form-control ' . ($errors->has('name') ? 'is-invalid' : '')) }}
                                    @error('name')
                        ...
                        <div class="col-xs-6 col-sm-12 col-md-6">
                            <div class="mb-3">
                                <div class="form-group">
                                    ...
                                    {{ html()->select('redirect_to', $redirectablePermission, isset($role) ? $role->redirect_to : old('redirect_to'))->placeholder('Select where to redirect this role')->class('form-control form-select' . ($errors->has('redirect_to') ? 'is-invalid' : '')) }}
                                    @error('redirect_to')
