                    ...
                    <div class="profile-widgets py-3">
                        <div class="text-center">
                            ...
                            <div class="mt-3 ">
                                ...
                                <p class="text-body mt-1 mb-1">admin@mailinator.com</p>
                                <p class="text-body mt-1 mb-1">Admin</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="profileinfo" role="tabpanel">
                            {!! Form::open([
                                'url' => route('wireframe.profile.index'),
                                'method' => 'PATCH',
                                'id' => 'user-form',
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('email', 'admin@mailinator.com', [
                                            'class' => 'form-control',
                                            'placeholder' => 'Email',
                                        ]) !!}
                                        {{-- @error('email')
