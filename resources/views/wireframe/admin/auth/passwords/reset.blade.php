@extends('wireframe.admin.layouts.master-without-nav')
@section('title')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="{{ route('wireframe.root') }}" class="d-inline-block auth-logo">
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input id="confirm-password-input" type="password"
                                                    name="password_confirmation" class="form-control password-input"
                                        ...
                                        <div id="password-contain" class="p-3 bg-light mb-2 rounded" style="display: none;">
                                            ...
                                            <p id="pass-lower" class="fs-12 mb-2 valid">At <b>lowercase</b> letter (a-z)</p>
