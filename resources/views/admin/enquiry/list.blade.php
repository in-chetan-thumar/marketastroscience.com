                ...
                <div class="card-body">
                    <div class="float-end ">
                        <div class="row row-cols-lg-auto g-3 align-items-center">
                            ...
                            {{-- <a href="{{ route('enquiries.create') }}" onclick="showSaveModel(event)"
                    ...
                    <div class="float-start">
                        {{ html()->form('get', route('enquiries.data'))->id('form-search')->class('row row-cols-lg-auto g-3 align-items-center')->open() }}
                        <div class="form-group">
...
@section('script-bottom')
    ...
    <script type="text/javascript" src="{{ asset('assets/js/enquiry.js') }}"></script>
    <script>
        $(document).ready(function() {
            initializeDataTable({
                moduleNmae: 'enquiry',
                tableSelector: '#enquiry-table-data', // Table id
                ajaxUrl: "/get-enquiries", // AJAX endpoint
                ...
                alwaysVisibleColumns: [0, 5, 6],
                // Default visible columns
                defaultVisibleColumn: [1, 2],
