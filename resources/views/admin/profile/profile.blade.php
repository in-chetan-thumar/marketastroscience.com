                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="profileinfo" role="tabpanel">
                            {{ html()->form('PATCH', route('profiles.update', auth()->user()->id))->attributes(['enctype' => 'multipart/form-data'])->id('user-form')->open() }}
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6 mb-2">
                                    <div class="form-group">
                                        {{ html()->label('Profile') }}
                                        {!! html()->input('file', 'profile')->class('form-control') !!}
                                        @error('profile')
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        {{ html()->input('text', 'name', isset(auth()->user()->name) ? auth()->user()->name : old('name'))->placeholder('Enter name')->class('form-control ' . ($errors->has('name') ? 'is-invalid' : '')) }}
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 mb-2">
                                    <div class="form-group">
                                        {{ html()->label('Email') }}<span class="required">*</span>
                                        {{ html()->input('email', 'email', isset(auth()->user()->email) ? auth()->user()->email : old('email'))->placeholder('Enter email')->class('form-control ' . ($errors->has('email') ? 'is-invalid' : '')) }}
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        {{ html()->input('text', 'mobile', isset(auth()->user()->mobile) ? auth()->user()->mobile : old('mobile'))->placeholder('Enter mobile')->attributes(['oninput' => 'this.value = this.value.replace(/[^0-9]/g, "")', 'maxlength' => '10'])->class('form-control ' . ($errors->has('mobile') ? 'is-invalid' : '')) }}
                                        @error('mobile')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <div class="tab-pane" id="changepassword" role="tabpanel">
                            {{ html()->form('POST', route('change.password'))->attributes(['enctype' => 'multipart/form-data'])->id('chagepassword-form')->open() }}
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input type="password" id="password-input" class="form-control password-input"
                                    ...
                                    <div id="password-contain" class="p-3 bg-light mb-2 rounded" style="display: none;">
                                        ...
                                        <p id="pass-lower" class="fs-12 mb-2 valid">At least one <b>lowercase</b> letter
                                            (a-z)</p>
                                        <p id="pass-upper" class="invalid fs-12 mb-2">At least one <b>uppercase</b> letter
                                            (A-Z)</p>
                                        <p id="pass-number" class="invalid fs-12 mb-2">At least one <b>number</b> (0-9)
                                        </p>
