 <!-- Header area start -->
  <header class="header__area-2" style="background: transparent;">
    <div class="header__inner-2">
      <div class="header__logo-2">
        <a href="/"><img src="{{ asset('frontend/images/logo/logo.webp') }}" height="33px" alt="Site Logo"></a>
      </div>
        ...
        <ul class="main-menu menu-anim">
          ...
          <li><a href="#"><div class="menu-text"><span>s</span><span>t</span><span>u</span><span>d</span><span>y</span></div></a>
            <ul class="main-dropdown">
              ...
              <li><a href="#">Nakstra</a></li>
              <li><a href="#">Video Library</a></li>
              <li><a href="#">Books</a></li>
            </ul>
          </li>
           <li><a href="#"><div class="menu-text"><span>c</span><span>o</span><span>n</span><span>t</span><span>a</span><span>c</span><span>t</span><span> </span><span>u</span><span>s</span></div></a>
          </li>
        </ul>
      </div>
      <div class="header__nav-icon-2">
        <button class="menu-icon-2" id="open_offcanvas"><img src="{{ asset('frontend/images/icon/menu-white.png') }}" alt="Menubar Icon"></button>
      </div>
    </div>
  </header>
  <!-- Header area end -->