...
Route::prefix('V1')->middleware(['throttle:60,1'])->group(function () {
    ...
    //Reset password
    Route::post('/verify-user', [LoginController::class, 'verifyUser'])->name('verify.user.api');
    Route::post('/reset-password', [LoginController::class, 'resetPassword'])->name('reset.password.api');    
