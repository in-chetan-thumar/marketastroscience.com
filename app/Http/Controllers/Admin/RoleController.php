...
class RoleController extends Controller
{
    ...
    {
        $redirectablePermission = app('permission-helper')->getRedirectablePermission();
        ...
        return view('admin.role.create_role', compact('permissions_data', 'redirectablePermission'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.role.edit_role', compact('role', 'permissions_data', 'redirectablePermission'));
    }
    ...
    public function update(RoleRequest $request, $id)
    {
        try {
            ...
            $request['permission'] = array_map('intval', $request->permission);
            $role = resolve('role-repo')->update($request, (int) $id);
